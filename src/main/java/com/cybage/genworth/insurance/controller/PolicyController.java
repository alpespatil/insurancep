...
public class PolicyController {
	...
	@GetMapping("/getAll")
	@ApiOperation(value = "This method is used to get all the policy details")
	...
	@PostMapping("/save")
	@ApiOperation(value = "This method is used to store the policy details for particular user")
	...
	@GetMapping("/get/{id}")
	@ApiOperation(value = "This method is used to get the policy details of user by using user id")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "ok"), @ApiResponse(code = 404, message = "not found") })
	...
	@ApiOperation(value = "This method is used to delete the policy details of user by using id")
	@ApiResponses(value = { @ApiResponse(code = 200, message = "ok"), @ApiResponse(code = 404, message = "not found") })
